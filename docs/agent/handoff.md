# Agent handoff — 2026-07-08 02:51:19Z
...
HEAD:    8ce064d docs(scoping): repertoire/reasoned-knowledge tier + autonomous VerifierConfirmed learning
...
b566b87 docs: operator runbook — exact owner-side stand-up steps post-migration
13cbc58 docs(tracking): attestation-v4 blind panel clean (2/2), gaps discharged
fcdb01e feat(corpus): attestation v4 — provenance bound as a commitment (Q6 wrinkle)
bc47e64 docs(tracking): PRs 17+18 merged; baton points at the corpus-service build
44d623a Merge pull request #18 from nathanfraske/claude/workflow-model-optimization-e1y1sx
5a7cd81 fix(secrets): require the hex value in the corpus-row gitleaks rule
```
