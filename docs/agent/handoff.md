# Agent handoff — 2026-07-08 04:24:38Z
...
HEAD:    c546cd9 docs: clarify intermittent = the PROBLEM, add unreliable/partial-fix guidance
status:  0 uncommitted path(s)
```

### Recent commits
```
c546cd9 docs: clarify intermittent = the PROBLEM, add unreliable/partial-fix guidance
55361ff docs: spell action names out (display_driver_uninstaller, not ddu)
25afaf3 docs: shop workflow authoring format (ground-truth capture template)
